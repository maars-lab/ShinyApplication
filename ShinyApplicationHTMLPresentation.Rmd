---
title: "Shiny Application HTML Presentation"
author: "maars-lab"
date: "2022-10-09"
...
## Interactive Plot
As Shiny applications are not supported in static R Markdown documents, please refer to  [ShinyApps](https://maars-lab.shinyapps.io/ShinyApplication/). 
```{r dir, echo=TRUE}
library(shiny)
shinyApp(
